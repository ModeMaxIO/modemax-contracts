...
export interface ChainlinkAggregator4PythBakInterface extends utils.Interface {
  functions: {
...
export interface ChainlinkAggregator4PythBak extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChainlinkAggregator4PythBakInterface;

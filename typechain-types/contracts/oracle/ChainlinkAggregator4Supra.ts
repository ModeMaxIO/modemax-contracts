...
export interface ChainlinkAggregator4SupraInterface extends utils.Interface {
  functions: {
    ...
    "setAdapterInfo(address,uint64)": FunctionFragment;
...
export interface ChainlinkAggregator4Supra extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChainlinkAggregator4SupraInterface;

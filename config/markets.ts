...
const config: {
  ...
  modetest: [
    {
      ...
      maxLongTokenPoolAmount: expandDecimals(8000, 8),
      maxShortTokenPoolAmount: expandDecimals(98_000_000, 18),

      maxLongTokenPoolAmountForDeposit: expandDecimals(8000, 8),
      maxShortTokenPoolAmountForDeposit: expandDecimals(98_000_000, 18),
    ...
    },
    {
      ...
      maxShortTokenPoolAmount: expandDecimals(88_000_000, 18),

      maxLongTokenPoolAmountForDeposit: expandDecimals(50_000, 18),
      maxShortTokenPoolAmountForDeposit: expandDecimals(80_000_000, 18),
    ...
    {
      tokens: { indexToken: "MODE", longToken: "MODE", shortToken: "USDT" },
      virtualTokenIdForIndexToken: hashString("PERP:MODE/USD"),
      virtualMarketId: hashString("SPOT:MODE/USD"),
      ...
      maxLongTokenPoolAmountForDeposit: expandDecimals(900_000_000, 18),
      maxShortTokenPoolAmountForDeposit: expandDecimals(80_000_000, 18),
      ...
      positionImpactPoolDistributionRate: expandDecimals(100, 42), // ~8.64 ETH/day
      minPositionImpactPoolAmount: expandDecimals(30000, 18), // 30 ETH
    ...
    {
      tokens: { indexToken: "WBTC", longToken: "MODE.m", shortToken: "USDT.m" },
      virtualTokenIdForIndexToken: hashString("PERP:WBTC/USD"),
      virtualMarketId: hashString("SPOT:WBTC/USD"),

      ...baseMarketConfig,

      maxLongTokenPoolAmount: expandDecimals(1_200_000_000, 18),
      maxShortTokenPoolAmount: expandDecimals(90_000_000, 18),

      maxLongTokenPoolAmountForDeposit: expandDecimals(920_000_000, 18),
      maxShortTokenPoolAmountForDeposit: expandDecimals(82_000_000, 18),
    ...
    {
      tokens: { indexToken: "MODE.m", longToken: "MODE.m", shortToken: "USDT.m" },
      virtualTokenIdForIndexToken: hashString("PERP:MODE.m/USD"),
      virtualMarketId: hashString("SPOT:MODE.m/USD"),
  ...
  rolluxtest: [
    {
      ...
      maxLongTokenPoolAmount: expandDecimals(8000, 18),
      maxShortTokenPoolAmount: expandDecimals(98_000_000, 6),

      maxLongTokenPoolAmountForDeposit: expandDecimals(8000, 18),
      maxShortTokenPoolAmountForDeposit: expandDecimals(98_000_000, 6),

      negativePositionImpactFactor: decimalToFloat(15, 11), // 0.05% for ~1,600,000 USD of imbalance
      positivePositionImpactFactor: decimalToFloat(9, 11), // 0.05% for ~2,700,000 USD of imbalance

      positionImpactPoolDistributionRate: expandDecimals(600, 30), // ~0.518 BTC/day
      minPositionImpactPoolAmount: expandDecimals(2, 18), // 2 BTC
  ...
  arbitrum: [
    ...
    },
    {
      ...
      maxLongTokenPoolAmount: expandDecimals(8_551, 18),
      maxShortTokenPoolAmount: expandDecimals(2_500_000, 6),

      maxLongTokenPoolAmountForDeposit: expandDecimals(6_841, 18),
